        ...
        >
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1 text-left">
              ...
              <p className={`text-sm font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
                {t('reg_merchant_desc') || <>Empower your business with <span className={isDark ? 'text-white' : 'text-slate-900'}>Deal</span><span style={{ color: '#F59E0B' }}>Fynd</span> smart commerce</>}
              </p>
            </div>
          </div>
        </button>
  ...
  const renderRegisterForm = () => (
    <div className={`px-6 pt-8 pb-safe-bottom flex flex-col ${isDark ? 'bg-slate-950' : 'bg-slate-50'}`}>
      <div className="w-full text-left mb-6">
        ...
        <p className={`text-sm font-medium ${isDark ? 'text-slate-400' : 'text-slate-500'}`}>
          {regRole === 'user' ? 'Join the network to discover local deals.' : <>Empower your business with <span className={isDark ? 'text-white' : 'text-slate-900'}>Deal</span><span style={{ color: '#F59E0B' }}>Fynd</span> smart commerce.</>}
        </p>
      </div>

          ...
          <div className={`w-full max-w-md rounded-2xl p-6 ${isDark ? 'bg-slate-900' : 'bg-white'}`}>
            ...
            <div className={`text-sm leading-relaxed mb-6 space-y-3 ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
              ...
              <p className="pt-2 font-medium">
                DealFynd and its affiliated companies shall not be held liable for any copyright infringement, legal claims, or damages resulting from images uploaded by merchants.
              </p>
            </div>

...
function buildTrialExpiryEmailHtml(
  ...
  return `
    ...
    <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 560px; margin: 0 auto; padding: 32px 24px; color: #1e293b; background: #ffffff;">
      ...
      <p style="font-size: 15px; line-height: 1.7; margin: 0 0 16px;">
        We hope you've been enjoying the premium features of DealFynd over the last few months! We're writing to let you know that your <strong>120-day free trial</strong> is set to conclude on <strong>${trialEndDate}</strong>.
      </p>
      ...
      <p style="font-size: 15px; line-height: 1.7; margin: 24px 0 8px;">
        Thank you for being a valued DealFynd merchant. We look forward to helping you grow your business in the coming month!
      </p>

      <p style="font-size: 15px; line-height: 1.7; margin: 0 0 4px;">Best regards,</p>
      <p style="font-size: 15px; line-height: 1.7; margin: 0; font-weight: 600;">The DealFynd Team</p>

      <!-- Footer -->
      <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 28px 0 16px;" />
      <p style="font-size: 12px; color: #94a3b8; text-align: center; line-height: 1.5;">
        DealFynd for Business &bull; You're receiving this because you signed up for a DealFynd merchant account.
      </p>
    </div>
  `;
}
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const emailSubject = 'Important: Your DealFynd Premium trial ends in 3 days \u{1F680}';
    const notifTitle = 'Your DealFynd trial ends in 3 days!';
    const notifBody = `Hi${merchantName ? ' ' + merchantName : ''}! Your DealFynd trial ends in 3 days. Your subscription of ${curr}${amount} will be automatically processed via Google Play on ${trialEndDate}.`;
